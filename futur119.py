...
SIGNAL_CONDITION_THRESHOLD = 15  # Number of conditions that must be true to generate a signal
    ...
    try:
        ...
        while True:
            try:
                ...
                # Check if we have at least 10 conditions met for either long or short
                long_signal = (long_condition_count >= SIGNAL_CONDITION_THRESHOLD)
                short_signal = (short_condition_count >= SIGNAL_CONDITION_THRESHOLD)
                ...
                # Determine if we should send an alert - no cooldown
                should_send_alert = (long_condition_count >= SIGNAL_CONDITION_THRESHOLD) or (short_condition_count >= SIGNAL_CONDITION_THRESHOLD)
                ...
                if should_send_alert:
                    ...
                    telegram_analysis_message = (
                        ...
                        f"LONG Conditions: {long_condition_count}/{len(conditions_long)}\n"
                        f"SHORT Conditions: {short_condition_count}/{len(conditions_short)}\n\n"
                    )
