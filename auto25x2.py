"""
HFT Auto Trading Bot — KuCoin Futures Edition (CONCURRENT OPTIMIZED - FIXED)
============================================================================
"""
...
print("HFT KuCoin Bot (25x / CONCURRENT OPTIMIZED) initialising...")
if _cleaned:
...
ANALYSIS_WINDOW_1M = 500 # Fixed naming to match actual slice
...
def compute_signals(buffer_5m, buffer_1m, live_price):
    ...
    # 2. Extrema Cycle (1m) - STRICT MUTUAL EXCLUSIVITY FIX
...
def print_conditions(sig):
    ...
    print(f"  === LONG:{long_true}/5 SHORT:{short_true}/5 -> LONG:{sig['is_long']} SHORT:{sig['is_short']}")
...
def main():
    ...
    print("  === STARTING MAIN LOOP (CONCURRENT) ===\n")
