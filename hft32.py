            ...
            if '1m' in signals:
                ...
                if 'ht_sine_percent_to_min' in signals['1m'] and 'ht_sine_percent_to_max' in signals['1m']:
                    ...
                    if EMA_SLOW_PERIOD and EMA_FAST_PERIOD:
                        ...
                        # Calculate the EMA signals
                        ema_slow = talib.EMA(close_prices, EMA_SLOW_PERIOD)[-1]
                        ema_fast = talib.EMA(close_prices, EMA_FAST_PERIOD)[-1]

                        print("EMA Slow:", ema_slow)
                        print("EMA Fast:", ema_fast)

                        # Check if the EMA cross signal has been generated
                        if close_prices[-1] < ema_fast < ema_slow and TRADE_SYMBOL not in momentum:
                            print("BUY signal")

                        elif close_prices[-1] > ema_fast > ema_slow and TRADE_SYMBOL in momentum:
                            print("SELL signal")
