                                    ...
                                    if closest_threshold < price:
                                        ...
                                        if market_mood_sr == "Bullish" or market_mood_sr == "Neutral":
                                            ...
                                            if forecast_direction == "Up":
                                                ...
                                                for timeframe in timeframes:
                                                    if timeframe == "5m" and dist_from_close_to_min < dist_from_close_to_max:
                                                        print("LONG condition 8: dist_from_close_to_min < dist_from_close_to_max")
                                                        if current_quadrant == 1:
                                                            print("LONG condition 9: current_quadrant == 1")
                                                            if momentum > 0:
                                    ...
                                    if closest_threshold > price:
                                        ...
                                        if market_mood_sr == "Bearish" or market_mood_sr == "Neutral":
                                            ...
                                            if forecast_direction == "Down":
                                                ...
                                                for timeframe in timeframes:
                                                    if timeframe == "5m" and dist_from_close_to_min > dist_from_close_to_max:
                                                        print("SHORT condition 8: dist_from_close_to_min > dist_from_close_to_max")
                                                        if current_quadrant == 4:
                                                            print("SHORT condition 9: current_quadrant == 4")
                                                            if momentum < 0:
