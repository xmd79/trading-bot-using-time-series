...
def scale_to_sine_cycles(timeframe):
    ...
    # Identify ABCDE cycles based on current frequencies
    freq_info = calculate_frequency_spectrum(sine_wave)
    avg_frequency = freq_info["avg_frequency"]

    # ABCDE cycle identification logic
    if 0 <= avg_frequency < 0.1:
        print(f"{timeframe} Cycle: A")
    elif 0.1 <= avg_frequency < 0.2:
        print(f"{timeframe} Cycle: B")
    elif 0.2 <= avg_frequency < 0.3:
        print(f"{timeframe} Cycle: C")
    elif 0.3 <= avg_frequency < 0.4:
        print(f"{timeframe} Cycle: D")
    elif 0.4 <= avg_frequency <= 0.5:
        print(f"{timeframe} Cycle: E")
