        ...
        if len(candles) > 0:
            ...
            if timeframe == "4h":
                ...
                if true_count >= 4:
                    ...
                    with open(signal_file1, "w") as f:
                        f.write(f"{timestamp} - SIGNAL: DIP found on 4h timeframe at {current_close:.2f}\n")
                    print(f"DIP found on 4h timeframe tf at {current_close:.2f} - Recorded to {signal_file}")
            ...
            if timeframe == "15m":
                ...
                if true_count >= 4:
                    ...
                    print(f"DIP found on 15min timeframe tf at {current_close:.2f} - Recorded to {signal_file}")
            ...
            if timeframe == "5min":
                ...
                if true_count >= 4:
                    timestamp = datetime.now().strftime("%Y-%m-%d %H:%M")
                    with open(signal_file3, "w") as f:
                        f.write(f"{timestamp} - SIGNAL: DIP found on 5min timeframe at {current_close:.2f}\n")
                    print(f"DIP found on 5min timeframe tf at {current_close:.2f} - Recorded to {signal_file}")
            ...
            if timeframe == "1m":
                ...
                if true_count >= 4:
                    timestamp = datetime.now().strftime("%Y-%m-%d %H:%M")
                    with open(signal_file4, "w") as f:
                        f.write(f"{timestamp} - SIGNAL: DIP found on 1min timeframe at {current_close:.2f}\n")
                    print(f"DIP found on 1min timeframe tf at {current_close:.2f} - Recorded to {signal_file}")
