...
def main():
    ...
    while True:
        ...
        try:     
            ...
            sentiment, market_quadrant, support_level, resistance_level, market_mood_unit, forecasted_price_unit = forecast_market_trends(close)
            ...
            print(f"Support Level: {support_level}")
            print(f"Resistance Level: {resistance_level}")
            print(f"Market Mood: {market_mood_unit}")
            print(f"Forecasted Price: {forecasted_price_unit}")
                                                    ...
                                                    if incoming_reversal == "Top": 
                                                        ...
                                                        if signal == "BUY":
                                                            ...
                                                            if predicted_market_mood == "Up":
                                                                print("LONG condition 11: predicted_market_mood == Up")                                                 
                                                                if momentum > 0:
                                                    ...
                                                    if incoming_reversal == "Dip": 
                                                        ...
                                                        if signal == "SELL":
                                                            ...
                                                            if predicted_market_mood == "Down":
                                                                print("SHORT condition 11: predicted_market_mood == Down")                                                 
                                                                if momentum < 0:
        ...
        del result_cycles, sentiment, market_quadrant, support_level, resistance_level, market_mood_unit, forecasted_price_unit
