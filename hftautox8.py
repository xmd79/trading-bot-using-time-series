        ...
        try:     
            ...
            with open("signals.txt", "a") as f:
                ...
                if un_realized_profit == 0:  
                    ...
                    elif normalized_distance_to_min > normalized_distance_to_max and closest_threshold == max_threshold and buy_volume_1min < sell_volume_1min and buy_volume_3min < sell_volume_3min and buy_volume_5min < sell_volume_5min and price > avg_mtf and forecast_direction == "Down" and market_mood_fft == "Bearish" and incoming_reversal == "Dip" and price > forecast and price > expected_price and pivot_mood == "Bearish" and momentum < 0 and long_conditions_met < short_conditions_met:
