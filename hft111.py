        ...
        try:     
            ...
            with open("signals.txt", "a") as f:   
                ...
                if current_quadrant == 1:
                    if price < avg_mtf and price < target5 and price < target4 and price < target3 and price < incoming_reversal_keypoint and price < future_price_regression and price < forecast_price_fft:
