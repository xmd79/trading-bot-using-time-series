...
def main():
    try:
        ...
        while True:
            ...
            current_long_condition_met = (long_condition_count >= SIGNAL_CONDITION_THRESHOLD)
            current_short_condition_met = (short_condition_count >= SIGNAL_CONDITION_THRESHOLD)
            
            # Get current time for cooldown check
            current_time = time.time()
            
            # FIXED: Always send an alert if conditions are met, with cooldown to prevent spam
