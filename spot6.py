...
def check_exit_condition(initial_investment, btc_balance):
    ...
    return current_value >= (initial_investment * 1.03)
...
while True:  
    ...
    for timeframe in timeframes:
        if timeframe in candle_map:
            ...
            angle_price = last_bottom + (last_top - last_bottom) / 2  # Midpoint for 45-degree
            print(f"45 Degree Angle Price: {angle_price:.2f}")
            ...
            if current_btc_price < angle_price:
