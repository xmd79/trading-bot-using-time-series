...
def get_rf_band(frequency):
    ...
    elif frequency >= 0.001 and frequency < 0.003: 
        return "VHF band (30MHz - 300MHz)"    
    elif frequency >= 0.0003 and frequency < 0.001:
        return "UHF band (300 MHz - 3 GHz)"        
    elif frequency >= 0.001 and frequency < 3:  
        return "SHF band (3 - 30 GHz)"
    elif frequency >= 3 and frequency < 30:   
        return  "EHF band (30 - 300 GHz)"         
    else:
...
def subatomic_map_function(close_prices, candles, particle_freqs):
    ...
    particles["Electron"]["Transitions"] = ["Electron to photon", "Electron to neutrino"]
    particles["Proton"]["Transitions"] = ["Proton to neutron", "Proton to antineutrino"]
    particles["Neutron"]["Transitions"] = ["Neutron to proton", "Neutron to antineutrino"]
    particles["Photon"]["Transitions"] = ["Photon to electron-positron pair"]
    particles["Quark"]["Transitions"] = ["Quark to hadron"]
    particles["Muon"]["Transitions"] = ["Muon to electron and neutrinos"]
    particles["Tau"]["Transitions"] = ["Tau to electron and neutrinos"]
    particles["Neutrino"]["Transitions"] = ["Neutrino oscillations"]
    particles["Antineutrino"]["Transitions"] = ["Antineutrino oscillations"]
    particles["W Boson"]["Transitions"] = ["W Boson to quarks"]
    particles["Z Boson"]["Transitions"] = ["Z Boson to quarks"]
    particles["Gluon"]["Transitions"] = ["Gluon to quarks and gluons"]
    particles["Higgs Boson"]["Transitions"] = ["Higgs Boson to fermions and bosons"]
    
    # Map frequency for each particle
    for particle, freq in particle_freqs.items():
...
particle_freqs = {
    ...
    "Proton": 2.246941056e+23, 
    "Neutron": 2.246946386e+23,  
    "Photon": 1.986445857e+16,  
    "Muon": 1.057841531e+20,
    "Quark": 1e+20, # Quark frequency  
    "Tau": 5.9079e+19,      
    "Neutrino": 1.509190217e+20,              
    "Antineutrino": 1.509190217e+20,              
    "W Boson": 2.085e+24,         
    "Z Boson": 1.629e+24, 
    "Gluon": 1e+21, # Gluon frequency
...
electron_properties = particles["Electron"]["Properties"]
print(electron_properties)
# "Negatively charged, low mass, spin 1/2"

electron_transitions = particles["Electron"]["Transitions"]
print(electron_transitions)
# "Electron to photon", "Electron to neutrino"

electron_frequency = particles["Electron"]["Frequency"]
print(electron_frequency)
...
proton_transitions = particles["Proton"]["Transitions"]
print(proton_transitions)
# "Proton to neutron", "Proton to antineutrino"

proton_frequency = particles["Proton"]["Frequency"]
print(proton_frequency)
# "Very low frequency (VLF) band"

neutron_properties = particles["Neutron"]["Properties"]
print(neutron_properties)
# "No net charge, similar mass to proton, spin 1/2"

neutron_transitions = particles["Neutron"]["Transitions"]
print(neutron_transitions)
# "Neutron to proton", "Neutron to antineutrino"

neutron_frequency = particles["Neutron"]["Frequency"]
print(neutron_frequency)
# "Low frequency (LF) band"

photon_properties = particles["Photon"]["Properties"]
print(photon_properties)
# "Zero mass, spin 1"

photon_transitions = particles["Photon"]["Transitions"]
print(photon_transitions)
# "Photon to electron-positron pair"

quark_properties = particles["Quark"]["Properties"]
print(quark_properties)
# "Fractional charges and spins, confined in hadrons"

quark_transitions = particles["Quark"]["Transitions"]
print(quark_transitions)
# "Quark to hadron"

quark_frequency = particles["Quark"]["Frequency"]
print(quark_frequency)
# "RF frequencies"

muon_properties = particles["Muon"]["Properties"]
print(muon_properties)
# "Negatively charged, heavier than electron, spin 1/2"

muon_transitions = particles["Muon"]["Transitions"]
print(muon_transitions)
# "Muon to electron and neutrinos"

muon_frequency = particles["Muon"]["Frequency"]
print(muon_frequency)
# "Radiofrequencies"

tau_properties = particles["Tau"]["Properties"]
print(tau_properties)
# "Negatively charged, heavier than muon, spin 1/2"

tau_transitions = particles["Tau"]["Transitions"]
print(tau_transitions)
# "Tau to electron and neutrinos"

tau_frequency = particles["Tau"]["Frequency"]
print(tau_frequency)
# "Radiofrequencies"

neutrino_properties = particles["Neutrino"]["Properties"]
print(neutrino_properties)
# "Very low mass, spin 1/2, weakly interacting"

neutrino_transitions = particles["Neutrino"]["Transitions"]
print(neutrino_transitions)
# "Neutrino oscillations"

neutrino_frequency = particles["Neutrino"]["Frequency"]
print(neutrino_frequency)
# "Very high frequencies"

antineutrino_properties = particles["Antineutrino"]["Properties"]
print(antineutrino_properties)
# "Same properties as neutrino, opposite charge"

antineutrino_transitions = particles["Antineutrino"]["Transitions"]
print(antineutrino_transitions)
# "Antineutrino oscillations"

antineutrino_frequency = particles["Antineutrino"]["Frequency"]
print(antineutrino_frequency)
# "Very high frequencies"

wboson_properties = particles["W Boson"]["Properties"]
print(wboson_properties)
# "Massive, charged, mediates weak force"

wboson_transitions = particles["W Boson"]["Transitions"]
print(wboson_transitions)
# "W Boson to quarks"

wboson_frequency = particles["W Boson"]["Frequency"]
print(wboson_frequency)
# "Very high frequencies"

zboson_properties = particles["Z Boson"]["Properties"]
print(zboson_properties)
# "Massive, neutral, mediates weak force"

zboson_transitions = particles["Z Boson"]["Transitions"]
print(zboson_transitions)
## "Z Boson to quarks and leptons"

zboson_frequency = particles["Z Boson"]["Frequency"]
print(zboson_frequency)
# "Very high frequencies"

gluon_properties = particles["Gluon"]["Properties"]
print(gluon_properties)
# "Massless, spin 1, mediates strong force"

gluon_transitions = particles["Gluon"]["Transitions"]
print(gluon_transitions)
# "Gluon to quarks"

gluon_frequency = particles["Gluon"]["Frequency"]
print(gluon_frequency)
# "RF frequencies"

higgs_properties = particles["Higgs Boson"]["Properties"]
print(higgs_properties)
# "Scalar particle, mediates Higgs field"

higgs_transitions = particles["Higgs Boson"]["Transitions"]
print(higgs_transitions)
# "Higgs boson to W and Z bosons, fermions"

higgs_frequency = particles["Higgs Boson"]["Frequency"]
print(higgs_frequency)
# "RF frequencies"
