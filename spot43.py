...
while True:
    ...
    for timeframe in ['1m', '3m', '5m']:
        if timeframe in candle_map:
            ...
            last_bottom, last_top, last_reversal, last_reversal_type = find_major_reversals(candle_map[timeframe], current_btc_price, min_threshold, max_threshold)
    ...
    for timeframe in ['1m', '3m', '5m']:
        if timeframe in candle_map:
            ...
            current_time, entry_price, stop_loss, reversal_target, market_mood = get_target(closes, n_components=5, last_major_reversal_type=last_major_reversal_type, 
