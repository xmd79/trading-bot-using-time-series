    ...
    while True:
        ...
        try:     
            ...
            with open("signals.txt", "a") as f:   
                ...
                if price < avg_mtf and price < fastest_target and price < target1 and market_mood_sr == "Bullish" and market_mood == "Bullish":
                    if price < price1 and price < price2 and price < price3:
                        if dist_from_close_to_min < dist_from_close_to_max:
                            if momentum > 0:
                                trigger_long = True

                if price > avg_mtf and price > fastest_target and price > target1 and market_mood_sr == "Bearish" and market_mood == "Bearish":
                    if price > price1 and price > price2 and price > price3:
