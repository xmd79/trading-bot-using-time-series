...
def check_exit_condition(initial_investment, btc_balance):
    ...
    return current_value >= (initial_investment * 1.0145)  # Adjusted for 1.45%
...
while True:
    ...
    if btc_balance > 0:
        ...
        # Set target profit percentage to 1.45%
        target_profit_percentage = 1.45
        ...
        print(f"Percentage distance to target profit (1.45%): {distance_to_target_profit:.25f}%")
    ...
    if position_open:
        ...
        if check_exit_condition(initial_investment, btc_balance):
            print("Target profit of 1.45% reached or exceeded. Initiating exit...")
    ...
    if not position_open:
        ...
        if all_conditions_met:
            ...
            if btc_balance > 0:
                ...
                if current_value_in_usdc >= (initial_investment * 1.0145):  # Update for 1.45%
