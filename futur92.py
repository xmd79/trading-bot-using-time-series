    ...
    try:
        ...
        while True:
            ...
            conditions_long = {
                ...
                "volume_1min_increasing": False,
                "advanced_fft_above_current": False,
            }
            ...
            conditions_short = {
                ...
                "volume_1min_decreasing": False,
                "advanced_fft_below_current": False,
            }
            ...
            required_long_conditions = [
                ...
                "volume_1min_increasing",
                "advanced_fft_above_current"
            ]
            ...
            required_short_conditions = [
                ...
                "volume_1min_decreasing",
                "advanced_fft_below_current"
            ]
            ...
            for timeframe in TIMEFRAMES:
                ...
                if timeframe == "1m":
                    conditions_long["volume_1min_increasing"] = volume_increasing
                    conditions_short["volume_1min_decreasing"] = volume_decreasing
                ...
                if timeframe == "1m":
                    conditions_long["advanced_fft_above_current"] = advanced_fft_forecast_price > current_close
                    conditions_short["advanced_fft_below_current"] = advanced_fft_forecast_price < current_close
                ...
                if timeframe == "1m":
                    ...
                    print(f"Volume 1min Increasing (Long Condition): {conditions_long['volume_1min_increasing']}")
                    print(f"Volume 1min Decreasing (Short Condition): {conditions_short['volume_1min_decreasing']}")
                    print(f"Advanced FFT Above Current (Long Condition): {conditions_long['advanced_fft_above_current']}")
                    print(f"Advanced FFT Below Current (Short Condition): {conditions_short['advanced_fft_below_current']}")
            ...
            for cond_pair in [
                ...
                ("volume_1min_increasing", "volume_1min_decreasing"),
                ("advanced_fft_above_current", "advanced_fft_below_current")
            ]:
