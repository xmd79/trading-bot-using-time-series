    ...
    try:
        ...
        while True:
            ...
            for timeframe in TIMEFRAMES:
                ...
                if timeframe == "5m":
                    conditions_long["below_middle_5m"] = current_close < middle_threshold
                    conditions_short["above_middle_5m"] = current_close > middle_threshold
            ...
            print(f"below_middle_5m: {conditions_long.get('below_middle_5m', False)}")
            ...
            print(f"above_middle_5m: {conditions_short.get('above_middle_5m', False)}")
