                ...
                if un_realized_profit == 0:  
                    ...
                    if current_quadrant == 1:
                        if price < avg_mtf and price < incoming_reversal_keypoint and price < future_price_regression and price < forecast_price_fft:
                            if market_mood_sr == "Bullish" or market_mood_sr == "Neutral" and forecast_direction == "Up" and distance_to_lower < distance_to_upper:
                    ...
                    if current_quadrant == 4:
                        if price > avg_mtf and price > incoming_reversal_keypoint and price > future_price_regression and price > forecast_price_fft:
                            if market_mood_sr == "Bearish" or market_mood_sr == "Neutral" and forecast_direction == "Down" and distance_to_upper < distance_to_lower:
