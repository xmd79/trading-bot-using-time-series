...
class Trader:
    ...
    def print_profitable_triangles(self):
        ...
        if profitable_triangles:
            # Print detailed information for the most profitable triangle
            triangle, (profit_percentage, rate1, cross_rate2, cross_rate3) = profitable_triangles[0]
            pair1, pair2, pair3 = triangle
            print("\nDetailed Calculation for the Most Profitable Triangle:")
