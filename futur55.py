...
HURST_WINDOW_SIZE = {"1m": 200, "3m": 200, "5m": 200}  # Window size for Hurst analysis
...
def calculate_thresholds(candles, timeframe_ranges=None):
    ...
    if timeframe_ranges and timeframe in ["1m", "3m"]:
        higher_tf = "3m" if timeframe == "1m" else "5m"
        ...
        while True:
            ...
            for timeframe in TIMEFRAMES:
                ...
                if not candle_map.get(timeframe):
                    ...
                    fft_results[timeframe] = {"time": current_local_time_str, "current_price": Decimal('0'), "fastest_target": Decimal('0'), "average_target": Decimal('0'), "reversal_target": Decimal('0'), "market_mood": "Bearish", "min_threshold": Decimal('0'), "middle_threshold": Decimal('0'), "max_threshold": Decimal('0'), "fft_phase": "TOP", "dominant_freq": 0.0}
                ...
                analysis_details[timeframe] = {
                    ...
                    "volume_ratio": volume_ratio, "volume_confirmed": volume_confirmed, "min_threshold": min_threshold,
                    "middle_threshold": middle_threshold, "max_threshold": max_threshold, "reversal_type": reversal_type,
                    ...
                    "support_levels": support_levels, "resistance_levels": resistance_levels, "buy_volume": buy_vol,
                    "sell_volume": sell_vol, "volume_mood": volume_mood, "price_range": price_range,
                    "hurst_trend": hurst_trend, "hurst_forecast_price": hurst_forecast_price
                }
