            ...
            if '1m' in signals:
                ...
                if 'ht_sine_percent_to_min' in signals['1m'] and 'ht_sine_percent_to_max' in signals['1m']:
                    ...
                    if EMA_SLOW_PERIOD and EMA_FAST_PERIOD:
                        ...
                        print(f"Quadrant {current_quadrant} summary:")
                        print(f"Min point: {min_point['point']} - {min_point['frequency']} Hz")
                        print(f"Max point: {max_point['point']} - {max_point['frequency']} Hz")
                        print(f"Reversals predicted in {forecast['min_reversal']['time']} days, from the {forecast['min_reversal']['point']} point.")
                        print(f"A second reversal is expected in {forecast['max_reversal']['time']} days, originating from {forecast['max_reversal']['point']}.")

                        # Print reversal predictions
