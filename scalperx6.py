...
class BinanceSineAnalyzer:
    ...
    def calculate_sine_wave_with_fft(self, prices, forecast_periods=5):
        ...
        return (price_at_recent_min, price_at_recent_max, current_sine_value, 
                forecast_min, forecast_max, forecast_middle, pct_from_forecast_min, pct_from_forecast_max,
    ...
    def analyze_pair_on_tf(self, symbol, tf_name, tf_interval):
        ...
        try:
            ...
            fib_range = price_at_recent_max - price_at_recent_min
            fib_23_6 = price_at_recent_max - 0.236 * fib_range
            fib_38_2 = price_at_recent_max - 0.382 * fib_range
            fib_50 = price_at_recent_max - 0.5 * fib_range
            fib_61_8 = price_at_recent_max - 0.618 * fib_range
            fib_78_6 = price_at_recent_max - 0.786 * fib_range
            
            # Calculate support and resistance levels
            support_levels = [price_at_recent_min, fib_38_2, fib_61_8]
            resistance_levels = [fib_23_6, fib_50, fib_78_6, price_at_recent_max]
    ...
    def print_technical_data(self, asset_data):
        ...
        for tf_name, tf_data in asset_data['timeframes'].items():
            ...
            print(f"  0% (Recent Max):        {self.format_decimal(tf_data['price_at_recent_max'])}")
            ...
            print(f"  100% (Recent Min):       {self.format_decimal(tf_data['price_at_recent_min'])}")
