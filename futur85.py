        ...
        try:
            ...
            for tf in TIMEFRAMES:
                ...
                message += (
                    ...
                    f"Momentum Increasing: {details.get('momentum_increasing', False)}\n"
                    f"Momentum Decreasing: {details.get('momentum_decreasing', False)}\n"
        ...
        while True:
            ...
            for timeframe in TIMEFRAMES:
                ...
                if timeframe == "1m":
                    ...
                    # Add conditions for HT_SINE cycle type
                    conditions_long["ht_sine_cycle_up_1m"] = ht_sine_cycle_type == "Up"
                    conditions_short["ht_sine_cycle_down_1m"] = ht_sine_cycle_type == "Down"
                ...
                # Ensure fft_forecast conditions are exact opposites
                conditions_long["fft_forecast_above_price_" + timeframe] = fft_forecast > current_close
                conditions_short["fft_forecast_below_price_" + timeframe] = not conditions_long["fft_forecast_above_price_" + timeframe]
                ...
                if timeframe == "1m":
                    ...
                    print(f"HT_SINE Cycle Up (Long Condition): {conditions_long['ht_sine_cycle_up_1m']}")
                    print(f"HT_SINE Cycle Down (Short Condition): {conditions_short['ht_sine_cycle_down_1m']}")
