...
LEVERAGE = 20
TAKE_PROFIT_ROI = Decimal('2.55')  # 4% TP based on initial USDC balance
STOP_LOSS_ROI = Decimal('-10.0')   # 4% SL based on initial USDC balance
...
while True:
    ...
    if position_open:
        ...
        print(f"Target Value (4% ROI): {target_value:.25f} USDC")
        print(f"Stop Loss Value (1% Loss): {stop_loss_value:.25f} USDC")
