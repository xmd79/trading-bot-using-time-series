...
def main():
    try:
        ...
        while True:
            ...
            # Generate signal only if all conditions are true
            long_signal = long_true_count == total_required_long  # All conditions must be true
            short_signal = short_true_count == total_required_short  # All conditions must be true
            ...
            current_long_condition_met = (long_true_count == total_required_long)  # All conditions must be true
            current_short_condition_met = (short_true_count == total_required_short)  # All conditions must be true
