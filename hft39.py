...
def main():
    ...
    while True:
        try:
            ...
            print("--------------------------------------------------------------------")
            print("Frequency Range   |   Proportion   |   Percentage")
            print(f"Alpha ({freq_alpha_range[0]} - {freq_alpha_range[1]} Hz)   |   {alpha_prop}    |    {alpha_perc}%")
            print(f"Beta ({freq_beta_range[0]} - {freq_beta_range[1]} Hz)   |   {beta_prop}    |    {beta_perc}%")
