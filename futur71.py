            ...
            if signal == "LONG":
                ...
                for tf in TIMEFRAMES:
                    ...
                    message += (
                        ...
                        f"Dist to Min: {dist_to_min:.2f} USDC\n"
                        f"Dist to Max: {dist_to_max:.2f} USDC\n"
    ...
    try:
        ...
        while True:
            ...
            conditions_long = {
                ...
                "cycle_target_above_price": False
            }
            ...
            conditions_short = {
                ...
                "cycle_target_below_price": False
            }
            ...
            for timeframe in TIMEFRAMES:
                ...
                if timeframe == "1m":
                    conditions_long["dist_to_min_less_than_dist_to_max"] = dist_to_min < dist_to_max
                    conditions_short["dist_to_max_less_than_dist_to_min"] = dist_to_max < dist_to_min
                    ...
                    conditions_long["cycle_target_above_price"] = cycle_target > current_close
                    conditions_short["cycle_target_below_price"] = cycle_target < current_close
                ...
                print(f"Dist to Min: {dist_to_min:.2f}")
                print(f"Dist to Max: {dist_to_max:.2f}")
            ...
            for tf in TIMEFRAMES:
                ...
                if tf == "1m":
                    ...
                    print(f"dist_to_min_less_than_dist_to_max: {conditions_long.get('dist_to_min_less_than_dist_to_max', False)}")
                    print(f"dist_to_max_less_than_dist_to_min: {conditions_short.get('dist_to_max_less_than_dist_to_min', False)}")
