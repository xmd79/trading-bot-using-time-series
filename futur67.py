...
VOLUME_CONFIRMATION_RATIO = Decimal('1.5')  # Buy/Sell volume ratio for confirmation
...
def main():
    try:
        ...
        while True:
            ...
            # Define conditions for LONG and SHORT signals, excluding momentum for 3m
            conditions_long = {
            ...
            conditions_long["volume_bullish_1m"] = False  # Only 1m volume for LONG
            ...
            conditions_short["volume_bearish_1m"] = False  # Only 1m volume for SHORT
            ...
            for timeframe in TIMEFRAMES:
                ...
                if timeframe == "1m":
                    conditions_long[f"volume_bullish_1m"] = buy_vol > sell_vol
                    conditions_short[f"volume_bearish_1m"] = sell_vol > buy_vol
