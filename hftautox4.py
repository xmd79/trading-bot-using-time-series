                    ...
                    if normalized_distance_to_min < normalized_distance_to_max and price < forecast_ht_price:
                        ...
                        if closest_threshold == min_threshold and price < avg_mtf and ht_mood == "Bullish": 
                            ...
                            if closest_threshold < price and forecast_direction == "Up" and spectrum_mood == "Bullish":  
                                ...
                                if market_mood_fft == "Bullish" and price < forecast_price_fft and rejections_mood == "Bullish":
                                    print("LONG condition 4: market_mood_fft == Bullish and price < forecast_price_fft and rejections_mood == Bullish")
